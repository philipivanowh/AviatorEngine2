...
struct AABB
{
    ...
    float Extent(int axis) const
    {
        switch (axis)
        {
        case 0: return max_x - min_x;
        case 1: return max_y - min_y;
        default: return max_z - min_z;
        }
    }
    ...
    float Centroid(int axis) const
    {
        switch (axis)
        {
        case 0: return (min_x + max_x) * 0.5f;
        case 1: return (min_y + max_y) * 0.5f;
        default: return (min_z + max_z) * 0.5f;
        }
    }
