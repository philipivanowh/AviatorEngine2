...
set_target_properties(LLVMMSSupport PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libLLVMMSSupport.a"
  )

list(APPEND _cmake_import_check_targets LLVMMSSupport )
list(APPEND _cmake_import_check_files_for_LLVMMSSupport "${_IMPORT_PREFIX}/lib/libLLVMMSSupport.a" )
...
set_target_properties(LLVMipa PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libLLVMipa.a"
  )

list(APPEND _cmake_import_check_targets LLVMipa )
list(APPEND _cmake_import_check_files_for_LLVMipa "${_IMPORT_PREFIX}/lib/libLLVMipa.a" )
...
set_target_properties(LLVMPassPrinters PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libLLVMPassPrinters.a"
  )

list(APPEND _cmake_import_check_targets LLVMPassPrinters )
list(APPEND _cmake_import_check_files_for_LLVMPassPrinters "${_IMPORT_PREFIX}/lib/libLLVMPassPrinters.a" )
...
set_target_properties(LLVMDxcSupport PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libLLVMDxcSupport.a"
  )

list(APPEND _cmake_import_check_targets LLVMDxcSupport )
list(APPEND _cmake_import_check_files_for_LLVMDxcSupport "${_IMPORT_PREFIX}/lib/libLLVMDxcSupport.a" )
...
set_target_properties(LLVMHLSL PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libLLVMHLSL.a"
  )

list(APPEND _cmake_import_check_targets LLVMHLSL )
list(APPEND _cmake_import_check_files_for_LLVMHLSL "${_IMPORT_PREFIX}/lib/libLLVMHLSL.a" )
...
set_target_properties(LLVMDXIL PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libLLVMDXIL.a"
  )

list(APPEND _cmake_import_check_targets LLVMDXIL )
list(APPEND _cmake_import_check_files_for_LLVMDXIL "${_IMPORT_PREFIX}/lib/libLLVMDXIL.a" )
...
set_target_properties(LLVMDxilContainer PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libLLVMDxilContainer.a"
  )

list(APPEND _cmake_import_check_targets LLVMDxilContainer )
list(APPEND _cmake_import_check_files_for_LLVMDxilContainer "${_IMPORT_PREFIX}/lib/libLLVMDxilContainer.a" )
...
set_target_properties(LLVMDxilHash PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libLLVMDxilHash.a"
  )

list(APPEND _cmake_import_check_targets LLVMDxilHash )
list(APPEND _cmake_import_check_files_for_LLVMDxilHash "${_IMPORT_PREFIX}/lib/libLLVMDxilHash.a" )
...
set_target_properties(LLVMDxilPdbInfo PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libLLVMDxilPdbInfo.a"
  )

list(APPEND _cmake_import_check_targets LLVMDxilPdbInfo )
list(APPEND _cmake_import_check_files_for_LLVMDxilPdbInfo "${_IMPORT_PREFIX}/lib/libLLVMDxilPdbInfo.a" )
...
set_target_properties(LLVMDxilPIXPasses PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libLLVMDxilPIXPasses.a"
  )

list(APPEND _cmake_import_check_targets LLVMDxilPIXPasses )
list(APPEND _cmake_import_check_files_for_LLVMDxilPIXPasses "${_IMPORT_PREFIX}/lib/libLLVMDxilPIXPasses.a" )
...
set_target_properties(LLVMDxilDia PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libLLVMDxilDia.a"
  )

list(APPEND _cmake_import_check_targets LLVMDxilDia )
list(APPEND _cmake_import_check_files_for_LLVMDxilDia "${_IMPORT_PREFIX}/lib/libLLVMDxilDia.a" )
...
set_target_properties(LLVMDxilRootSignature PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libLLVMDxilRootSignature.a"
  )

list(APPEND _cmake_import_check_targets LLVMDxilRootSignature )
list(APPEND _cmake_import_check_files_for_LLVMDxilRootSignature "${_IMPORT_PREFIX}/lib/libLLVMDxilRootSignature.a" )
...
set_target_properties(LLVMDxilValidation PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libLLVMDxilValidation.a"
  )

list(APPEND _cmake_import_check_targets LLVMDxilValidation )
list(APPEND _cmake_import_check_files_for_LLVMDxilValidation "${_IMPORT_PREFIX}/lib/libLLVMDxilValidation.a" )
...
set_target_properties(LLVMDxcBindingTable PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libLLVMDxcBindingTable.a"
  )

list(APPEND _cmake_import_check_targets LLVMDxcBindingTable )
list(APPEND _cmake_import_check_files_for_LLVMDxcBindingTable "${_IMPORT_PREFIX}/lib/libLLVMDxcBindingTable.a" )
...
set_target_properties(LLVMDxrFallback PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libLLVMDxrFallback.a"
  )

list(APPEND _cmake_import_check_targets LLVMDxrFallback )
list(APPEND _cmake_import_check_files_for_LLVMDxrFallback "${_IMPORT_PREFIX}/lib/libLLVMDxrFallback.a" )
...
set_target_properties(LLVMDxilCompression PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "C;CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libLLVMDxilCompression.a"
  )

list(APPEND _cmake_import_check_targets LLVMDxilCompression )
list(APPEND _cmake_import_check_files_for_LLVMDxilCompression "${_IMPORT_PREFIX}/lib/libLLVMDxilCompression.a" )
